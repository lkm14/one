...
public class MemberVO implements Serializable{
	private String member_id;				// 회원 id : 기본키
	...
	private String member_addr1;			// 회원 주소
	private String member_addr2;			// 회원 상세주소
	private String member_regdate;			// 회원 가입날짜
	private String member_lastip;			// 회원 마지막접속ip
	private int member_level;				// 회원 등급
	private int member_point;				// 회원 마일리지(포인트)
